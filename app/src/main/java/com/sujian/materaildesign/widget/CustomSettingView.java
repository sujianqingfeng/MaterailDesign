...
public class CustomSettingView extends LinearLayout {
    ...
    private void initCustomSettingView(Context context) {
    ...
    private void initAllViews(Context context) {
        ...
        Preference<Float> bFloat = rxSharedPreferences.getFloat(Constant.KEY_TEXT_SIZE, 12.0f);
        mTextSizeSeek.setProgress((int) ((aFloat.get()- 15.0f) * 100 / 3.0f));
        mLineSpaceSeek.setProgress((int) ((bFloat.get()- 12.0f) * 100 / 3.0f));
